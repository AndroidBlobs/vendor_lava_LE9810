...
LOCAL_MODULE := CmasEM
LOCAL_MODULE_OWNER := lava
LOCAL_SRC_FILES := proprietary/vendor/app/CmasEM/CmasEM.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
...
include $(CLEAR_VARS)
LOCAL_MODULE := LavaCalendar
LOCAL_MODULE_OWNER := lava
LOCAL_SRC_FILES := proprietary/vendor/app/LavaCalendar/LavaCalendar.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
