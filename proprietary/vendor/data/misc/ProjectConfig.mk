...
CUSTOM_HAL_IMGSENSOR =s5k3l8_dmegc_mipi_raw s5k3l8_hongshi_mipi_raw  s5k4h7yx_dmegc_mipi_raw s5k4h7yx_hongshi_mipi_raw
CUSTOM_HAL_LENS = dw9718s_op68_dmegc_af dw9718s_op68_hongshi_af dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS = 
CUSTOM_HAL_MAIN_IMGSENSOR = s5k3l8_dmegc_mipi_raw s5k3l8_hongshi_mipi_raw 
CUSTOM_HAL_MAIN_LENS = dw9718s_op68_dmegc_af dw9718s_op68_hongshi_af
CUSTOM_HAL_MSENSORLIB = akl
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR =
CUSTOM_HAL_SUB_BACKUP_LENS = 
CUSTOM_HAL_SUB_IMGSENSOR =  s5k4h7yx_dmegc_mipi_raw s5k4h7yx_hongshi_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR =s5k3l8_dmegc_mipi_raw s5k3l8_hongshi_mipi_raw  s5k4h7yx_dmegc_mipi_raw s5k4h7yx_hongshi_mipi_raw
CUSTOM_KERNEL_IN_POCKET_SENSOR = no
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = dw9718s_op68_dmegc_af dw9718s_op68_hongshi_af dummy_lens 
CUSTOM_KERNEL_MAGNETOMETER = no
CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN2_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_LENS = 
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5k3l8_dmegc_mipi_raw s5k3l8_hongshi_mipi_raw 
CUSTOM_KERNEL_MAIN_LENS = dw9718s_op68_dmegc_af dw9718s_op68_hongshi_af
...
CUSTOM_KERNEL_SUB_IMGSENSOR =  s5k4h7yx_dmegc_mipi_raw s5k4h7yx_hongshi_mipi_raw
CUSTOM_KERNEL_SUB_LENS = dummy_lens
CUSTOM_KERNEL_TILT_DETECTOR_SENSOR = no
CUSTOM_KERNEL_TOUCHPANEL = hxchipset
...
ifeq ($(LAVA_COUNTRY_VERSION),)
CUSTOM_MODEM = lava6762_op68_int_sp_lwctg_dsds
else
CUSTOM_MODEM = lava6762_op68_$(LAVA_COUNTRY_VERSION)_sp_lwctg_dsds
endif
...
MTK_BUILD_VERNO = alps-mp-o1.mp7
MTK_BWC_SUPPORT = yes
MTK_C2K_LTE_MODE = 0
...
#lingbj add 2018.01.24
ifeq ($(LAVA_COUNTRY_VERSION),int)
...
#adupsfota end
## fingerprint
LAVA_FINGERPRINT_BTL = yes
LAVA_FINGERPRINT_SUNWAVE = yes
## audio awinic
LAVA_AWINIC_AUDIO = yes

#jiangym added for lava faceunlock end
LAVA_FACE_UNLOCK_ST = yes
#jiangym added end

########################################
UV_CAMERA_BEAUTYSHOT = yes
UV_CAMERA_SPOTLIGHT = yes
MP_CAMERA_HDR = yes
MP_CAMERA_NIGHTSHOT =yes
ARCSOFT_CAMERA_RELIGHTING = yes
ARCSOFT_CAMERA_VIDEOBEAUTY = yes
APPMAGIC_CAMERA_STICKER = yes
LAVA_SUPER_NIGHT = yes
LAVA_SCREEN_FLASH = yes
LAVA_CAM_DEB_LOG_ON = no
LAVA_FLIP = yes
LAVA_MACRO_SHOT = yes
########################################
